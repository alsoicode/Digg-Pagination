"""
Modified by Brandon Taylor, btaylordesign@gmail.com to accept a context variable for the paginate_by parameter.
This allows you to set the value from a cookie, session or other means than specifying an integer in the
autopaginate template tag
...
def do_autopaginate(parser, token):
    ...
    if len(split) == 2:
        ...
        try:
            ...
            raise template.TemplateSyntaxError(u'PLease specify a "paginate_by" value in the context or an integer')
...
class AutoPaginateNode(template.Node):
    ...
    def render(self, context):
        ...
        try:
            paginate_by = int(self.paginate_by.resolve(context))
        except template.VariableDoesNotExist:
            paginate_by = int(self.paginate_by)
